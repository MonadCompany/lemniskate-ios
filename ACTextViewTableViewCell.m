...
@interface ACTextViewTableViewCell () <MDCTextViewViewControllerDelegate>
...
@implementation ACTextViewTableViewCell
...
{
    ACTextViewViewController *controller = [[ACTextViewViewController alloc] initWithText:self.contentLabel.text];
