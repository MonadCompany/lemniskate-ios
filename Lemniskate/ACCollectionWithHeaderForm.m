...
@interface ACCollectionWithHeaderForm ()
...
@implementation ACCollectionWithHeaderForm
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerClass:[ACWordTableViewCell class] forCellReuseIdentifier:MDCWordTableCellViewReuseIdentifier];
    }
    return _tableView;
}
