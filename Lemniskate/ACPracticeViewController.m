...
@interface ACPracticeViewController () <ZLSwipeableViewDataSource, ZLSwipeableViewDelegate>
...
@implementation ACPracticeViewController
...
- (UIView *)nextViewForSwipeableView:(ZLSwipeableView *)swipeableView {
    ...
    if (self.wordsLeft.count > 0) {
        ...
        ACWordCardView *view = [[ACWordCardView alloc] initWithFrame:cardBounds];
        [view setWord:word];
